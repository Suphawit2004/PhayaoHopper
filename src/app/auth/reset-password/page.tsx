  ...
  return (
    <div className="feature-page mx-auto w-full max-w-lg px-4 py-8">
      ...
      {user ? <>
        ...
        <p className="mb-6"><UiText text="กรอกอีเมลที่ใช้สมัครเพื่อรับลิงก์ตั้งรหัสผ่านใหม่" en="Enter your account email to receive a password reset link." /></p>
        <PasswordResetRequest />
        <Link className="ui-secondary mt-4" href="/login"><UiText text="กลับไปเข้าสู่ระบบ" en="Back to sign in" /></Link>
      </>}
    </div>
  );
}
