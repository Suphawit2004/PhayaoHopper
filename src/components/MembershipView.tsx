...
export default function MembershipView(){
 ...
 <section className="feature-card"><h2>{c("คูปองจากประสบการณ์ของคุณ","Rewards for your experiences")}</h2><p>{c("บันทึกว่าเคยไปแล้วและรีวิว รับคูปองทดลอง 5 บาท หรือแนบรูปสาธารณะอย่างน้อย 3 รูปเพื่อรับ 10% แทน อายุ 30 วัน เฉพาะร้านที่รีวิว รับได้ครั้งเดียวต่อบัญชีต่อร้าน","Mark a cafe as visited and review it for a demo ฿5 coupon, or attach at least 3 public photos for 10% instead. Valid for 30 days at that cafe. One reward per account per cafe.")}</p><p className="mt-3 font-semibold">{c("ใช้สาธิตเท่านั้น ไม่สามารถแลกส่วนลดจริง","Demo only. Not redeemable for real discounts.")}</p><Link className="feature-button mt-5" href="/coupons">{c("คูปองของฉัน","My coupons")} →</Link></section></div>;
}
